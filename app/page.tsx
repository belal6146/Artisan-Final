    ...
    <div className="flex flex-col min-h-screen relative font-sans">
        ...
        <div className="container mx-auto max-w-5xl z-10 text-center space-y-12">
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl font-light leading-relaxed mx-auto italic text-pretty animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
              A professional ecosystem built for emerging talent. 
              Bridging the gap between universal talent and local opportunity.
            </p>
          </div>
        ...
        <div className="container mx-auto space-y-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-l-2 border-primary/10 pl-8">
            <div className="space-y-4">
               <h2 className="font-serif text-4xl md:text-5xl font-medium tracking-tight">Featured Selection</h2>
               <p className="text-muted-foreground max-w-md text-sm leading-relaxed tracking-wide">
                  Hand-picked pieces from our global collective, curated monthly for technical excellence and cultural depth.
               </p>
            </div>
      ...
      <section className="py-40 bg-background relative overflow-hidden">
         <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-20">
            <div className="space-y-6 p-8 border border-border/5 hover:border-border/20 transition-all">
               ...
               <h3 className="font-serif text-2xl font-medium">True Transparency</h3>
               <p className="text-sm text-muted-foreground leading-relaxed">
                  Every price is broken down. Know exactly how much goes to materials, the artisan, and the community fund.
               </p>
            </div>
            <div className="space-y-6 p-8 border border-border/5 hover:border-border/20 transition-all">
               <Globe className="h-8 w-8 text-primary/60 mb-8" />
               <h3 className="font-serif text-2xl font-medium">Global Connection</h3>
               <p className="text-sm text-muted-foreground leading-relaxed">
                  We empower artists in underserved regions by giving them a premium global stage and immediate liquidity.
               </p>
            </div>
            <div className="space-y-6 p-8 border border-border/5 hover:border-border/20 transition-all">
               <Users className="h-8 w-8 text-primary/60 mb-8" />
               <h3 className="font-serif text-2xl font-medium">Community Owned</h3>
               <p className="text-sm text-muted-foreground leading-relaxed">
                  Artisan is more than a store. It's a cooperative ecosystem where every member shares in the collective growth.
               </p>
            </div>
         </div>
      </section>
      ...
      <section className="py-32 border-t border-border/10">
         <div className="container mx-auto max-w-4xl text-center space-y-10">
            <h2 className="font-serif text-4xl md:text-5xl font-medium">The Artisan Journal</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-light">
               Stories of process, people, and place. Dive deep into the lives of the makers behind the work.
            </p>
            <Link href="/journal">
