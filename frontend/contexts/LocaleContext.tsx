...
const DICTIONARY: Record<Language, Record<string, string>> = {
    en: {
        ...
        support: "Support",
        legal: "Legal",
        brand_tagline: "Work, price, and context in one place for artists and the people who value their labor.",
        home_hero_title: "Artisan.",
        home_hero_subtitle: "Browse work with origin, process, and price split stated where the artist has provided them.",
        explore_gallery: "Open gallery",
        find_collaborators: "Collaboration",
        featured_selection: "On the home page right now",
        featured_subtitle: "A small set of listed works; nothing here is ranked or promoted for effect.",
        view_collection: "See all listed work",
        true_transparency: "Price split",
        transparency_desc: "When an artist supplies breakdown percentages, we show how much is set aside for materials, their share, community, and platform operations.",
        global_connection: "Who can use this",
        connection_desc: "Anyone listing here sets their own context and terms. The site is a shared venue, not a guarantee of reach or sales.",
        community_owned: "Shared venue",
        community_desc: "Fees and flows are described in each listing where data exists. There is no stock story that fits every maker.",
        read_stories: "Open journal",
        journal_subtitle: "Notes from artists who choose to publish them. Length and topic vary by author.",
        gallery_title: "Gallery",
        gallery_subtitle: "Read slowly. Each piece has its own page for origin, labor, materials, and anything else the artist entered.",
        global_discovery: "Browse",
        no_artworks_found: "No artworks found.",
        mission_title: "The Mission.",
        mission_subtitle: "This project exists to give artwork the same room for context that a studio visit would—not to replace one.",
        humanity_title: "Fair pay",
        humanity_desc: "Listings can show how price is divided. What artists earn in practice depends on their sales and their own settings.",
        env_title: "Materials & shipping",
        env_desc: "Environmental claims belong on the piece or the artist profile when the maker chooses to include them.",
        culture_title: "Context",
        culture_desc: "Heritage and meaning should come from the maker’s words, not from generic site copy.",
        radical_transparency: "What we show",
        transparency_commitment: "We display splits and fields when artists provide them. We do not fill gaps with marketing language.",
        artisan_share: "Artisan Share",
        platform_fee: "Platform Fee",
        impact_fund: "Impact Fund",
        join_movement: "Create an account",
        support_artisans: "Support an artist",
        share_craft: "List your work",
